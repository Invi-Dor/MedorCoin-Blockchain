...
void register_medor_to_btc_route(crow::SimpleApp &app) {
    CROW_ROUTE(app, "/api/convert/medor/btc").methods("POST"_method)
    ([](const crow::request&, crow::response& res){
        json price = getCoinGeckoPrice("medorcoin", "btc");
