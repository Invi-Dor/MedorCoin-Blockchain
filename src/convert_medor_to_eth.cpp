...
void register_medor_to_eth_route(crow::SimpleApp &app) {
    CROW_ROUTE(app, "/api/convert/medor/eth").methods("POST"_method)
    ([](const crow::request&, crow::response& res){
        json price = getCoinGeckoPrice("medorcoin", "eth");
