...
// SELF-TEST LOGIC FOR THE NEW IP: 172.235.50.31
if (require.main === module) {
    const genesis = Block.genesis();
    console.log("--- MEDORCOIN NETWORK DIAGNOSTIC ---");
    console.log("Binding to IP: 172.235.50.31");
    console.log("Header Size: " + genesis.header.length + " bytes");
    console.log("Genesis Hash: " + genesis.hash);
    console.log("Status: " + (genesis.verify() ? "READY" : "FAILED"));
}
